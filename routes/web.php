...
Route::middleware('auth')->group(static function () {
    ...
    Route::get('/author/{user}/{post:slug}/edit', [PostController::class, 'edit'])
        ->withHidden()
        ->name('author.posts.edit');
    Route::put('/author/{user}/{post:slug}', [PostController::class, 'update'])
        ->withHidden()
        ->name('author.posts.update');
    Route::delete('/author/{user}/{post:slug}', [PostController::class, 'destroy'])
        ->withHidden()
        ->name('author.posts.destroy');
    Route::post('/logout', [AuthController::class, 'logout'])->name('logout');

    Route::post('/author/{user}/{post:slug}/comment', [CommentController::class, 'store'])
        ->withHidden()
        ->name('author.posts.comment');
});
...
Route::get('/author/{user}/{post:slug}', [PostController::class, 'show'])
    ->withHidden()
    ->name('author.posts.show');
